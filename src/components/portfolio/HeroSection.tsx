...
const HeroSection = () => {
  ...
  return (
    <section id="hero" className="min-h-screen flex items-center justify-center section-padding bg-gradient-to-br from-background via-background to-background-secondary">
      <div className="max-w-4xl mx-auto text-center animate-fade-in">
        ...
        <div className="mb-8 animate-scale-in">
          <div className="w-32 h-32 mx-auto mb-6 rounded-full overflow-hidden border-4 border-brand-primary/20 shadow-lg hover:shadow-brand-primary/30 transition-all duration-300">
            <img 
              src={developerAvatar} 
              alt="Kaio Gustavo - Desenvolvedor Front-End" 
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-12">
          <Button 
            variant="outline" 
            size="sm" 
            className="glass-card hover:bg-brand-primary hover:text-text-inverse transition-all duration-300"
          ...
          <Button 
            ...
            size="sm"
            className="glass-card hover:bg-brand-primary hover:text-text-inverse transition-all duration-300"
            onClick={() => window.open('tel:+5583987922753')}
          >
          ...
          <Button 
            ...
            size="sm"
            className="glass-card hover:bg-brand-primary hover:text-text-inverse transition-all duration-300"
            onClick={() => window.open('https://github.com/Kaiobrl', '_blank')}
          >
